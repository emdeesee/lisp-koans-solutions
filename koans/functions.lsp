...
(define-test test-optional-parameters
   ...
   (assert-equal (func-with-opt-params :test-1 :test-2) (list :test-1 :test-2))
   (assert-equal (func-with-opt-params :test-1) (list :test-1 3))
   (assert-equal (func-with-opt-params) (list 2 3)))
...
(define-test test-optional-parameters-with-indication
   ...
   (assert-equal (func-with-opt-params-and-indication :test-1 :test-2) (list :test-1 t :test-2 t))
   (assert-equal (func-with-opt-params-and-indication :test-1) (list :test-1 t 3 nil))
   (assert-equal (func-with-opt-params-and-indication) (list 2 nil 3 nil)))
